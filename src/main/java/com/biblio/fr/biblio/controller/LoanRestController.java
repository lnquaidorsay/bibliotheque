...
import com.biblio.fr.biblio.entite.LoanDTO;
import com.biblio.fr.biblio.entite.LoanId;
import com.biblio.fr.biblio.entite.LoanStatus;
import com.biblio.fr.biblio.entite.SimpleLoanDTO;
import com.biblio.fr.biblio.service.impl.LoanServiceImpl;
...
public class LoanRestController {
	...
	/**
	 * Retourne l'historique des prêts en cours dans la bibliothèque jusqu'à une
	 * certaine date maximale.
	 * 
	 * @param maxEndDateStr
	 * @return
	 */
